...
import { Github, Linkedin, Mail, Phone, MapPin, Download, Brain, Cpu, Zap } from 'lucide-react';
  ...
  return (
    <section className="hero-gradient h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 md:w-96 h-80 md:h-96 bg-blue-500/20 rounded-full blur-3xl animate-pulse floating-card"></div>
        <div className="absolute -bottom-40 -left-40 w-80 md:w-96 h-80 md:h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000 floating-card"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 md:w-80 h-60 md:h-80 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-500 floating-card"></div>
      ...
      <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
        <div className="animate-fade-in">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold mb-4 md:mb-6 relative">
            <span className="gradient-text text-shadow-glow">Surya Vishnu</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-3 md:gap-8 mb-8 md:mb-12 text-gray-300 animate-fade-in px-4">
            <div className="flex items-center gap-2 md:gap-3 glass-effect px-3 md:px-4 py-2 rounded-full magnetic-hover text-sm md:text-base">
              <Mail size={16} className="md:w-[18px] md:h-[18px] text-blue-400" />
              <span className="font-medium truncate">suryakenguva1@gmail.com</span>
            </div>
            <div className="flex items-center gap-2 md:gap-3 glass-effect px-3 md:px-4 py-2 rounded-full magnetic-hover text-sm md:text-base">
            ...
            <div className="flex items-center gap-2 md:gap-3 glass-effect px-3 md:px-4 py-2 rounded-full magnetic-hover text-sm md:text-base">
              <MapPin size={16} className="md:w-[18px] md:h-[18px] text-purple-400" />
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 mb-8 md:mb-12 animate-fade-in px-4">
            ...
            >
              <Github className="mr-2 md:mr-3 group-hover:rotate-12 transition-transform duration-300" size={18} />
              GitHub
            </Button>
            <Button 
              variant="outline" 
              ...
              className="neon-border bg-transparent hover:bg-blue-600/20 hover:scale-110 transition-all duration-300 group text-sm md:text-base"
            >
              <Linkedin className="mr-2 md:mr-3 group-hover:rotate-12 transition-transform duration-300" size={18} />
              LinkedIn
            </Button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 animate-fade-in px-4">
            ...
            >
              <Download className="mr-2 md:mr-3 group-hover:animate-bounce" size={18} />
              Download Resume
            </Button>
          </div>
        </div>
